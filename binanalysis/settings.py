...
def parse_args():
    ...
    parser.add_argument("--llm-url", type=str, help="LLM API base URL (default: http://ollama:11434)")
...
def build_settings(args) -> Settings:
    ...
    settings = Settings(
        ...
        # LLM report
        llm_url=getattr(args, "llm_url", None) or llm_cfg.get("url", "http://ollama:11434"),
        llm_model=getattr(args, "llm_model", None) or llm_cfg.get("model", "qwen3.5"),
        llm_timeout=getattr(args, "llm_timeout", None) or llm_cfg.get("timeout", 600),
